...
export function DashboardPage() {
  ...
  const cam1 = cameras.find((c) => c.entity_id === preferences.dashboardCameras[0]) ?? cameras[0] ?? null;
  const cam2 = cameras.find((c) => c.entity_id === preferences.dashboardCameras[1]) ?? cameras[1] ?? null;
